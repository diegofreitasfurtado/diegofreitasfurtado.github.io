# Guia do Portfolio — índice rápido

Este arquivo é um **índice**. Toda regra e detalhe vive nos documentos canônicos.

> Para evitar duplicação, **não escreva regras aqui**. Edite o arquivo canônico correspondente.

---

## Documentos canônicos (na raiz)

| Para entender / editar... | Vá para |
|---|---|
| Estrutura geral, hierarquia de regras, índice de READMEs | [`README.md`](./README.md) |
...
| `scraps/` (sketches descartáveis) | [`scraps/README.md`](./scraps/README.md) |
